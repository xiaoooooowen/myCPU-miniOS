...
TEST(RVTests, TestBeq) {
  {
    std::string code = start +
        ...
        "end: j end \n";
    Cpu cpu = rv_helper(code, "test_beq_taken", 4);
    EXPECT_EQ(cpu.regs[3], 42) << "Error: x3 should be 42 when beq is taken";
  }
  {
    std::string code = start +
        "addi x1, x0, 1 \n"
        ...
        "target: addi x3, x0, 0 \n"
        "end: j end \n";
    Cpu cpu = rv_helper(code, "test_beq_not_taken", 4);
    EXPECT_EQ(cpu.regs[3], 42) << "Error: x3 should be 42 when beq is not taken";
  }
}
...
TEST(RVTests, TestBne) {
  {
    std::string code = start +
        ...
        "target: addi x3, x0, 42 \n"
        "end: j end \n";
    Cpu cpu = rv_helper(code, "test_bne_taken", 4);
    EXPECT_EQ(cpu.regs[3], 42) << "Error: x3 should be 42 when bne is taken";
  }
  {
    std::string code = start +
        "addi x1, x0, 5 \n"
        ...
        "target: addi x3, x0, 0 \n"
        "end: j end \n";
    Cpu cpu = rv_helper(code, "test_bne_not_taken", 4);
    EXPECT_EQ(cpu.regs[3], 42) << "Error: x3 should be 42 when bne is not taken";
  }
}
...
TEST(RVTests, TestBlt) {
  std::string code = start +
      ...
      "target: addi x3, x0, 42 \n"
      "end: j end \n";
  Cpu cpu = rv_helper(code, "test_blt", 4);
  EXPECT_EQ(cpu.regs[3], 42) << "Error: x3 should be 42 when blt is taken (-5 < 3)";
}
...
TEST(RVTests, TestBge) {
  std::string code = start +
      ...
      "target: addi x3, x0, 42 \n"
      "end: j end \n";
  Cpu cpu = rv_helper(code, "test_bge", 4);
  EXPECT_EQ(cpu.regs[3], 42) << "Error: x3 should be 42 when bge is taken (10 >= 5)";
}
...
TEST(RVTests, TestBgeu) {
  std::string code = start +
      ...
      "target: addi x3, x0, 42 \n"
      "end: j end \n";
  Cpu cpu = rv_helper(code, "test_bgeu", 4);
  EXPECT_EQ(cpu.regs[3], 42) << "Error: x3 should be 42 when bgeu is taken (unsigned -1 > 1)";
}
...
TEST(RVTests, TestSh) {
  std::string code = start +
      ...
      "sh x1, 0(x2) \n"
      "lhu x3, 0(x2) \n";
  Cpu cpu = rv_helper(code, "test_sh", 4);
  EXPECT_EQ(cpu.regs[3], 0xffff) << "Error: x3 should be 0xffff after SH + LHU";
}
...
TEST(RVTests, TestSw) {
  std::string code = start +
      ...
      "sw x1, 0(x2) \n"
      "lwu x3, 0(x2) \n";
  Cpu cpu = rv_helper(code, "test_sw", 5);
  EXPECT_EQ(cpu.regs[3], 0x12345678) << "Error: x3 should be 0x12345678 after SW + LWU";
}
